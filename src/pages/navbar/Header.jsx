  ...
  return (
    <div className="bg-[#89b4d4]">
      ...
      >
        ...
        {isLoginPopupOpen && (
          <div className="fixed inset-0 z-50 flex items-center h-auto justify-center bg-black/30 backdrop-blur-sm">
            <div
              ref={popupRef}
              className="relative bg-white rounded-2xl shadow-xl h-auto max-w-4xl w-full m-4 p-6 animate-fade-in"
            >
              <button
