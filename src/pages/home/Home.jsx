...
const Home = () => {
  ...
  <>
  <Header/>
    <section className="relative bg-gradient-to-br from-background via-blue-50/30 to-primary/5 py-12 sm:py-16 lg:py-20 xl:py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            {/* Notification card */}
            <div className="absolute top-4 right-4 lg:top-8 lg:right-8 p-3 lg:p-4 w-64 lg:w-72 bg-background/95 backdrop-blur-sm border shadow-lg hidden md:block rounded-lg">
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 p-3 sm:p-4 bg-background/95 backdrop-blur-sm border shadow-lg rounded-lg">
            ...
            <div className="absolute top-4 -right-2 sm:top-8 sm:-right-4 p-2 sm:p-3 bg-background/95 backdrop-blur-sm border shadow-lg rounded-lg">
